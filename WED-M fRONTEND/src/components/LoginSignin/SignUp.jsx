...
const SignUp = () => {
    ...
    return (
        <div className="w-full object-cover overflow-hidden font-montserrat h-screen">
            ...
            <div className="w-full h-screen" >
                <div className='w-full relative h-full bg-cover bg-center' style={{ backgroundImage: `url('./y2.jpg')` }}>
                    <div className="absolute w-full h-[42vw] px-[4vw] py-[2vw]">
                        <div className='w-full h-full rounded-3xl p-[4vw] gap-10 bg-[#FFFEFE] flex justify-center items-center'>
                            ...
                            <div className="left  w-[50%] h-full bg-[#FFFAF2] rounded-3xl py-8 px-16">
                                <h1 className='text-[#A15233] text-2xl font-medium '>Sign Up</h1>
                                <h1 className='text-[#343A40] font-medium mt-3'>Let’s create your account</h1>
